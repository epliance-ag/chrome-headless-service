...
#Huge thanks to: https://gist.github.com/brechtm/891de9f72516c1b2cbc1
...
DIFFDIR="pdfDiffDirectory"                        # directory to place diff images in
MAXPROCS=$(($(getconf _NPROCESSORS_ONLN)/2))
if [ $MAXPROCS -lt 1 ]; then
MAXPROCS=1    # number of parallel processes
fi
